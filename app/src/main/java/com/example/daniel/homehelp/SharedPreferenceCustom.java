...
public class SharedPreferenceCustom {
    ...
    public void putSharedPrefFloat(String key, Float value) {
        this.sharedPreferences.edit().putFloat(key, value).commit();
    }

    public void putSharedPrefStringArray(String key, List<String> values) {
    ...
    public float getSharedPrefFloat(String key) {
